...
trainingFileFormat = "../../training/Hattstedt_training.csv"
modelFileFormat = "training/Hattstedt/model.h5"
...
# Feature Daten
features = data[['season_1','season_2', 'season_3', 'season_4', 'year', 'month', 'day', 'hour_sin', 'hour_cos', 'prev_temp', 'prev_hum', 'humidity', 'coverage', 'wind_dir', 'wind_str', 'prec']]
