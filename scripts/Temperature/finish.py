...
if __name__ == '__main__':
    for station in places:
        ...
        with open("../../data/Temperature/" + station["station"] + "/clean.csv", 'r') as cleanfile:
    ...
    for single_date in daterange(startDate, endDate):
        ...
        for station in places:
            try:
                entries[(date + "07")].append(station["data"][int(date + "07")])
                entries[(date + "14")].append(station["data"][int(date + "14")])
                entries[(date + "21")].append(station["data"][int(date + "21")])
            except KeyError:
                print("error")
                exit()
